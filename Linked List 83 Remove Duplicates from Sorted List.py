...
Input: head = [SONY Interview Question.py,2,3,3,4,4,5]
Output: [SONY Interview Question.py,2,5]

Example 2:

Input: head = [SONY Interview Question.py,SONY Interview Question.py,SONY Interview Question.py,2,3]
Output: [2,3]
